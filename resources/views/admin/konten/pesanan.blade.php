...
@section('title', __('Cat Point - Daftar Pesanan'))
                    ...
                    if (data.rc === 200 && data.success) {
                        ...
                        var table = $('#zero_config').DataTable({
                            ...
                            columns: [{
                                ...
                                {
                                    data: 'booking.ciri_khusus_hewan'
                                },
                                {
                                    data: 'booking.umur_kucing'
                                },
                                {
                                    data: 'booking.jenis_kucing'
                                },
                                {
                                ...
                                {
                                    data: 'booking.jenis_kelamin_kucing'
                                }
                            ]
                        });
