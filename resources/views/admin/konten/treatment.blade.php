            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.rc === 200 && data.success) {
                        ...
                        // Add script to handle the "Edit" button click event
                        $('#zero_config tbody').on('click', '.edit-btn', function() {
                            var selectedId = $(this).data('id');

                            $.ajax({
                                url: 'http://149.129.244.179/api/service/' + selectedId,
                                type: 'GET',
                                headers: {
                                ...
                                success: function(data) {
                                    if (data.rc === 200 && data.success) {
                                        $('#modal-edit input[name="name"]').val(data
                                            .result.paket_fluffy);
                                        $('#modal-edit input[name="harga"]').val(
                                            data.result.harga);
                                        $('#modal-edit input[name="deskripsi"]')
                                            .val(data.result.deskripsi);
                                        $('#modal-edit input[name="gambar"]').val(
                                            data.result.gambar);
                                    } else {
                                        console.error(
                                            'Error fetching data for editing');
                                    }
                                },
